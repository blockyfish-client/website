		...
		<main className="flex flex-col items-center bg-gray-900 px-4 pb-8 w-screen min-h-screen text-white">
			...
			<div className="flex flex-col items-center gap-4 mt-8 w-full max-w-5xl">
				...
				<div id="download" className="flex flex-col items-center gap-4">
					...
					<Link
						className="flex justify-center items-center gap-3 bg-blue-600 hover:bg-blue-700 shadow-lg px-4 py-3 border-b-4 border-blue-700 hover:border-blue-800 rounded-2xl text-white transition-colors"
						href={
							"https://github.com/blockyfish-client/desktop-client/releases/download/v3.2.1/blockyfish-client-win-3.2.1.exe"
						}
					>
						<svg
					...
					<Link
						className="flex justify-center items-center gap-3 border-gray-700 hover:border-gray-800 bg-gray-600 hover:bg-gray-700 shadow-lg px-4 py-3 border-b-4 rounded-2xl text-white transition-colors"
						href={
							"https://github.com/blockyfish-client/desktop-client/releases/download/v3.2.1/blockyfish-client-mac-3.2.1.dmg"
						}
					>
						<svg
							xmlns="http://www.w3.org/2000/svg"
					...
					<div className="flex shadow-lg">
						<Link
							className="flex justify-center items-center gap-3 border-orange-700 hover:border-orange-800 bg-orange-600 hover:bg-orange-700 px-4 py-3 border-b-4 rounded-s-2xl text-white transition-colors"
							href={
								"https://github.com/blockyfish-client/desktop-client/releases/download/v3.2.1/blockyfish-client-linux-3.2.1.tar.xz"
							}
						>
							<svg
								xmlns="http://www.w3.org/2000/svg"
						...
						<Link
							className="flex justify-center items-center gap-3 border-orange-700 border-x hover:border-orange-800 bg-orange-600 hover:bg-orange-700 px-4 py-3 border-b-4 text-white transition-colors"
							href={
								"https://github.com/blockyfish-client/desktop-client/releases/download/v3.2.1/blockyfish-client-linux-3.2.1.tar.xz"
							}
						>
